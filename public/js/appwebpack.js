...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(1), __webpack_require__(2), __webpack_require__(32).setImmediate))
...
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_form__ = __webpack_require__(14);
...
const app = new __WEBPACK_IMPORTED_MODULE_1_vue__["a" /* default */]({
    ...
    mounted(){
        __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('/api/skills').then(response=>this.skills = response.data);
